<p align="center">
  ...
  <b>Vi trenger din hjelp til å oversette denne README-en, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">白狐 UI</a> og <a href="https://github.com/rustdesk/doc.rustdesk.com">白狐 Doc</a> tid ditt morsmål</b>
</p>
...
白狐 er velkommen for bidrag fra alle. Se [CONTRIBUTING.md](docs/CONTRIBUTING-NO.md) for hjelp med oppstart.
...
Venligst pass på att du kjører disse kommandoene fra roten av 白狐 repositoret, eller kan det hende att applikasjon ikke finner de riktige ressursene. Pass også på att andre cargo subkommandoer som for eksempel `install` eller `run` ikke støttes med denne metoden da de vill installere eller kjøre programmet i konteineren istedet for verten.
