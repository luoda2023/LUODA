<p align="center">
  <img src="../res/logo-header.svg" alt="白狐 - il tuo desktop remoto"><br>
  ...
  <b>Abbiamo bisogno del tuo aiuto per tradurre questo file README e la <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">UI 白狐</a> nella tua lingua nativa</b>
</p>
...
白狐 accoglie il contributo di tutti. Per ulteriori informazioni su come iniziare a contribuire, vedi [CONTRIBUTING.md](CONTRIBUTING-IT.md).
