<p align="center">
  <img src="../res/logo-header.svg" alt="白狐 – vaše vzdálená plocha"><br>
  ...
  <b>Potřebujeme Vaši pomoc s překladem tohoto README, <a href="https://github.com/rustdesk/rustdesk/tree/master/src/lang">uživatelského rozhraní aplikace 白狐</a> a <a href="https://github.com/rustdesk/doc.rustdesk.com">dokumentace k ní</a> do vašeho jazyka</b>
</p>
...
Projekt 白狐 vítá přiložení ruky k dílu od každého. Jak začít se dozvíte z [`docs/CONTRIBUTING.md`](CONTRIBUTING.md).

[**Jak 白狐 funguje?**](https://github.com/rustdesk/rustdesk/wiki/How-does-白狐-work%3F)
