...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa 白狐 mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et 白狐 oma süsteemi paigaldada."),
        ...
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [白狐 Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep 白狐 background service", "Säilita RustDeski taustateenus"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda 白狐 Server Pro versioonile {} või uuem!"),
