...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 白狐 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 白狐 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 白狐 \"网络接入\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让整个会议都在加密中进行，你需要允许 白狐 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [白狐 Input] 服务开启。"),
        ("android_new_connection_tip", "收到新的连接控制请求，对方想要控制你当前的设备。"),
        ("android_service_will_start_tip", "开启录屏权限将自动开启服务，允许其他设备向此设备请求建立连接。"),
        ("android_stop_service_tip", "关闭会议将自动关闭所有已建立的连接。请谨慎操作"),
        ("android_version_audio_tip", "当前安卓版本不支持音频录制，请升级至安卓 10 或更高。"),
        ("android_start_service_tip", "点击开始会议，请将相应权限开启。"),
        ("android_permission_tip", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [白狐 Input] 服务开启。"),
        ("android_permission_input_tip", "为了让整个会议都在加密中进行，你需要允许 白狐 使用\"无障碍\"服务。"),
        ("android_permission_audio_tip", "为了让整个会议都在加密中进行，你需要允许 白狐 使用\"录音\"服务。"),
        ("android_permission_screen_tip", "为了让整个会议都在加密中进行，你需要允许 白狐 使用\"屏幕录制\"服务。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep 白狐 background service", "保持 白狐 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 白狐 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ("Start the screen sharing service on boot, requires special permissions", "开机自动启动会议服务，此功能需要一些特殊权限。"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 白狐 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 白狐 \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 白狐 的 UAC 窗口点击确认。"),
        ...
        ("verify_rustdesk_password_tip", "验证 白狐 密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 白狐 启动服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，白狐 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 白狐 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 白狐 后台服务"),
        ("Keep screen on", "保持屏幕开启"),
        ("Never", "从不"),
        ("During controlled", "会议进行中"),
        ...
        ("View camera", "查看摄像头"),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "请在远程端将 白狐 客户端升级至版本 {} 或更新版本！"),
