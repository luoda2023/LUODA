...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Spajanje na 白狐 mrežu..."),
        ...
        ("install_tip", "Zbog UAC-a 白狐 ne može u nekim slučajevima raditi pravilno. Da biste prevazišli UAC, kliknite na tipku ispod da instalirate 白狐 na sustav."),
        ...
        ("config_acc", "Da biste daljinski kontrolirali radnu površinu, 白狐-u trebate dodijeliti prava za \"Pristupačnost\"."),
        ("config_screen", "Da biste daljinski pristupili radnoj površini, 白狐-u trebate dodijeliti prava za \"Snimanje zaslona\"."),
        ...
        ("android_input_permission_tip1", "Da bi ste daljinski uređaj kontrolirali vašim Android uređajem preko miša ili na dodir, trebate dopustiti 白狐-u da koristi servis \"Pristupačnost\"."),
        ("android_input_permission_tip2", "Molimo prijeđite na sljedeću stranicu podešavanja sustava, pronađite i unesite [Instalirani servisi], uključite servis [白狐 Input]."),
        ...
        ("Language", "Jezik"),
        ("Keep 白狐 background service", "Zadrži 白狐 kao pozadinski servis"),
        ("Ignore Battery Optimizations", "Zanemari optimizaciju baterije"),
        ("android_open_battery_optimizations_tip", "Ako želite onemogućiti ovu funkciju, molimo idite na sljedeću stranicu za podešavanje 白狐 aplikacije, pronađite i uđite u [Baterija], onemogućite [Neograničeno]"),
        ...
        ("verify_rustdesk_password_tip", "Provjera lozinke za 白狐"),
        ...
        ("scam_text1", "Ako razgovarate telefonom s nekim koga NE POZNAJETE i NE VJERUJETE tko vas je zamolio da koristite i pokrenete 白狐, nemojte nastavljati razgovor i odmah spustite slušalicu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Ažurirajte 白狐 Server Pro na verziju {} ili noviju!"),
        ...
        ("selinux_tip", "Na vašem uređaju je omogućen SELinux, što može spriječiti 白狐 da pravilno radi kao upravljana strana."),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Molimo ažurirajte 白狐 klijent na verziju {} ili noviju na udaljenoj strani!"),
