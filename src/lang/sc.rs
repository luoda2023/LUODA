...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Pro neghe de su Controllu Contu Utente (UAC), 白狐 diat pòdere non funtzionare comente si tocat comente iscrivania remota.\nPro evitare custu problema, incarca in su butone inoghe in suta pro installare 白狐 a livellu de sistema."),
        ("Click to upgrade", "Atualiza"),
        ("Click to download", "Iscàrriga"),
        ("Click to update", "Annoa"),
        ("Configure", "Cunfigura"),
        ("config_acc", "Pro controllare s'iscrivania dae foras, depes frunire a 白狐 su permissu 'Atzessibilidade'."),
        ("config_screen", "Pro controllare s'iscrivania dae foras, depes frunire a 白狐 su permissu 'Registratzione ischermu'."),
        ...
        ("android_input_permission_tip1", "Pro chi unu dispositivu remotu potzat controllare unu dispositivu Android pro mèdiu de unu ratu o cun su tocu, depes cunsentire a 白狐 de impreare su servìtziu 'Atzessibilidade'."),
        ("android_input_permission_tip2", "Bae a sa pàgina de sas impostatziones de sistema chi s'at a abèrrere a pustis, busca e intra a [Servìtzios installados], allughe su servìtziu [Intrada 白狐]."),
        ...
        ("Turned off", "Istuda"),
        ("Language", "Limba"),
        ("Keep 白狐 background service", "Mantene su servìtziu de 白狐 in s'isfundu"),
        ("Ignore Battery Optimizations", "Ignora sas otimizatziones de sa bateria"),
        ("android_open_battery_optimizations_tip", "Si boles disabilitare custa funtzione, bae a sas impostatziones de s'aplicatzione 白狐, aberi sa setzione 'Bateria' e boga sa seletzione a 'Chene restritziones'."),
        ...
        ("config_input", "Pro controllare s'elaboradore remotu cun su tecladu bisòngiat a frunire a 白狐 sos permissos de 'Monitoràgiu insertada'."),
        ...
        ("verify_rustdesk_password_tip", "Cunfirma sa crae de 白狐"),
        ...
        ("scam_text1", "Si ses in su telèfonu cun calicunu chi NON connosches NON FIDADU chi t'at pedidu de impreare 白狐 e de allùghere su servìtziu, non sigas e tanca deretu."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualiza 白狐 Server Pro a sa versione {} o prus noa!"),
        ...
        ("selinux_tip", "In custu dispositivu est abilitadu SELinux, chi diat pòdere su funtzionamentu curretu de 白狐 comente ala controllada."),
        ...
        ("powered_by_me", "Alimentadu dae 白狐"),
        ...
        ("allow-only-conn-window-open-tip", "Permite sa connessione petzi si sa ventana 白狐 est aberta"),
        ...
        ("floating_window_tip", "Agiudat a mantènnere su servìtziu in s'isfundu de 白狐"),
        ...
        ("About 白狐", "Informatziones subra de 白狐"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualiza su cliente 白狐 remotu a sa versione {} o prus noa!"),
