...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Devido ao UAC, o 白狐 não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o 白狐 no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao 白狐 permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao 白狐 permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o 白狐 use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [白狐 Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep 白狐 background service", "Manter o serviço do 白狐 executando em segundo plano"),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do 白狐"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o 白狐 e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o 白狐 Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o 白狐 funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por 白狐"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do 白狐 estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço 白狐 em segundo plano"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente 白狐 para a versão {} ou superior no lado remoto."),
