...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Devido ao UAC, o 白狐 não funciona correctamente em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o 白狐 no sistema."),
        ...
        ("config_acc", "Para controlar o seu Ambiente de Trabalho remotamente, é preciso conceder ao 白狐 permissões de \"Acessibilidade\"."),
        ("config_screen", "Para aceder ao seu Ambiente de Trabalho remotamente, é preciso conceder ao 白狐 permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle o seu dispositivo Android via rato ou toque, você precisa permitir que o 白狐 use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], ACTIVE o serviço [白狐 Input]."),
        ...
        ("Language", "Linguagem"),
        ("Keep 白狐 background service", "Manter o serviço 白狐 em funcionamento"),
