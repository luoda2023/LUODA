...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használatakor. A megfelelő működés érdekében, telepítse a 白狐 alkalmazást a számítógépére."),
        ...
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a [白狐 Input] szolgáltatást."),
        ...
        ("Language", "Nyelv"),
        ("Keep 白狐 background service", "白狐 futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívül hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a 白狐 alkalmazás beállításaiba, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ...
        ("still_click_uac_tip", "A távoli felhasználónak továbbra is az „Igen” gombra kell kattintania a 白狐 UAC ablakában. Kattintson!"),
        ...
        ("verify_rustdesk_password_tip", "白狐 jelszó megerősítése"),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Frissítse a 白狐 Server Prot a(z) {} vagy újabb verzióra!"),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a 白狐 nem fut megfelelően, mint ellenőrzött webhely."),
        ...
        ("powered_by_me", "Üzemeltető: 白狐"),
        ("outgoing_only_desk_tip", "Ez a 白狐 testre szabott kimenete.\nMás eszközökhöz kapcsolódhat, de más eszközök nem kapcsolódhatnak az Ön eszközéhez."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a kapcsolódást, ha a 白狐 ablak nyitva van."),
        ...
        ("floating_window_tip", "Segít, ha a 白狐 a háttérben fut."),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Frissítse a 白狐 klienst {} vagy újabb verziójára a távoli oldalon!"),
