...
#define HRESULT_ERR_ELEMENT_NOT_FOUND 0x80070490
    ...
    LPCWCH RD_PRINTER_PORT = L"白狐 Printer";
    LPCWCH RD_PRINTER_NAME = L"白狐 Printer";
    LPCWCH RD_PRINTER_DRIVER_NAME = L"白狐 v4 Printer Driver";
    ...
    {
        // If the printer is used after the spooler service is started. E.g., printing a document through 白狐 Printer.
